...
flags.DEFINE_string("env", "OrcaCubePickBinary-Vision-v0", "Name of environment.")
...
flags.DEFINE_multi_string("demo_paths", "/home/ccc/orca_ws/src/serl/examples/orca_pick_cube_drq/orca_cube_pick_21_demos_2025-06-24_17-40-06.pkl", "paths to demos")
flags.DEFINE_string("checkpoint_path", "/home/ccc/orca_ws/src/serl/examples/orca_pick_cube_drq/bc_binary", "Path to save checkpoints.")

flags.DEFINE_integer(
    "eval_checkpoint_step", 10000, "evaluate the policy from ckpt at this step"
)
